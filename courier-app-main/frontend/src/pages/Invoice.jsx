        ...
        const fetchShipment = async () => {
            try {
                ...
                setShipment({
                    ...
                    price: 450,
                    weight: 2.5,
                    courier_owner: 'CourierWithUs Premium',
                    status: 'paid'
                });
            } finally {
                setLoading(false);
        ...
        <div className="invoice-page animate-fade-in" style={{ padding: '2rem', maxWidth: '900px', margin: '0 auto' }}>
            ...
            <div className="card invoice-container" style={{
                ...
                <div className="flex justify-between items-start mb-12 border-b pb-8">
                    <div>
                        <h1 style={{ color: 'var(--primary)', fontSize: '2.5rem', margin: 0, fontWeight: 800 }}>CourierWithUs</h1>
                        <p className="text-muted" style={{ marginTop: '0.5rem' }}>Fast, Secure & Reliable Deliveries</p>
                        <div className="mt-4 flex items-center gap-2 text-sm text-gray-500">
                            <Globe size={14} /> www.courierwithus.com
                        </div>
                    </div>
                ...
                <div style={{ marginTop: '4rem', paddingTop: '2rem', borderTop: '1px solid #f3f4f6' }}>
                    ...
                    <p className="text-xs text-gray-400 leading-relaxed">
                        ...
                        The shipment is subject to the terms of carriage of CourierWithUs.
                        For any support, please contact us at support@courierwithus.com.
                    </p>
                </div>
            </div>
